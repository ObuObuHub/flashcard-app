...
interface StudyClientProps {
  deck: Deck
  initialFlashcards: FlashcardWithStats[]
}
...
export function StudyClient({ deck, initialFlashcards }: StudyClientProps) {
  const [flashcards] = useState<FlashcardWithStats[]>(initialFlashcards)
  ...
  const handleRating = useCallback(async (rating: SRSRating) => {
    ...
    try {
      ...
      console.error('Eroare la salvarea revizuirii:', error)
    } finally {
